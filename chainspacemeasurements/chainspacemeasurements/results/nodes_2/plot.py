...
ax0.set_title("TWO NODES PER SHARD")
...
#plt.savefig("Graph_Clever_Random_NODE_TWO.png")
...
ax[0].set_title("Distribution of the tps in function of the number of shard(s) used with TWO NODES")
...
for row in range(rows):
	...
	ax[row].legend()
plt.xlabel("Tps")
#plt.savefig("Graph_distrib_Clever_Random_NODE_TWO.png")
