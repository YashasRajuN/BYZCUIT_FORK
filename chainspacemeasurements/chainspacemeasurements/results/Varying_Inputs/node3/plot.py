...
ax0.set_title("INPUT PLOT WITH THREE NODES PER SHARD")
...
plt.savefig("Graph_Clever_Random_NODE_THREE_INPUTS.png")
...
for row in range(rows):
	...
	ax[row].legend()
plt.xlabel("Tps")
plt.savefig("Graph_distrib_Clever_Random_NODE_THREE_INPUTS.png")
